const CACHE_VERSION = '1.7.11.1';

const BASE_CACHE_FILES = [
    '/wp-content/uploads/2020/05/1988.png',
'/wp-content/uploads/2020/05/1988-2.png',

];

const OFFLINE_CACHE_FILES = [
     'https://git.1988.designworks.tw/',
];
...
const OFFLINE_PAGE = 'https://git.1988.designworks.tw/';
const NOT_FOUND_PAGE = 'https://git.1988.designworks.tw/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://git.1988.designworks.tw//wp-admin/');
//    },
];
